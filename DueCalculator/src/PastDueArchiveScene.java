...
/**
 * The PastDueArchiveScene prompts users to select the way they want to
 * search through past dues assessed. They can search a specific member's 
 * dues based on their name and year or generate a full report for a 
 * specific year.
 *
 * @author	Alena Zhang
 * @since	2020-03-11
 */
public class PastDueArchiveScene extends Scene {
	...
	public PastDueArchiveScene(Parent root){
		super(root);
		...
		Text titleText = new Text("Past Due Archives");
		...
		searchButton = new Button("Search Based on Name and Year");
		fullReportButton = new Button("Full Reports by Year");
